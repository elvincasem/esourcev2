...
MySQL - 5.6.17 : Database - esourcev2
*********************************************************************
*/
...
insert  into `adjustment_details`(`adjustmentid`,`adj_purpose`,`adj_time_stamp`,`warehouseid`,`userID`) values (1,'Adjustment for Actual Count','2017-04-20 15:00:00',2,1),(3,'test','2017-04-20 16:42:27',1,1);
...
insert  into `equipments_par`(`parid`,`parno`,`pardate`,`eid`) values (2,'dsa','2017-04-01',30);
...
insert  into `equipments_ptr`(`ptrid`,`ptrno`,`ptrdate`,`fromoffice`,`tooffice`,`transfertype`,`transferreason`) values (3,'22222','2017-04-10','dd','ff','OTHERS','asdasd');
...
insert  into `equipments_rre`(`rreid`,`rreno`,`rredate`,`rre_enduser`,`rre_timestamp`) values (1,'2017-0417','2017-04-18','ELVIN CASEM1','2017-04-17 10:19:57'),(3,'jk834','2017-04-17','lynnette','2017-04-17 10:41:15');
...
insert  into `equipments_rre_items`(`rreitemsid`,`rreid`,`equipno`,`assetid`,`paricsno`,`enduseroffice`,`rre_remarks`) values (3,1,5,2,'rawer','ELVIN CASEM1','era'),(4,3,5,2,'3848','lynnette','me');
...
insert  into `purchase_apr_items`(`apritemsid`,`aprid`,`itemid`,`description`,`qty`,`unit`,`unitprice`,`availability`) values (1,1,172,'CLIP, backfold, 19mm, 12 pieces per box',1,'BOX',7000.28,'NO'),(2,1,196,'FOLDER, Tagboard, A4, 100 pieces per pack',1,'PACK',179.28,'NO');
...
insert  into `purchase_pr_aoc`(`aocid`,`prid`,`pritemsid`,`supplierid`,`unitprice`) values (114,23,107,16,30.00),(115,24,108,5,1500.00),(116,24,109,5,1398.00),(117,24,110,5,500.00),(118,24,111,5,0.00),(121,25,112,3,0.00),(122,22,106,2,50.00),(123,22,113,2,30.00),(124,22,106,4,10.00),(125,22,113,4,30.00);
...
insert  into `purchase_receiving_items`(`deliveryitemsid`,`deliveryid`,`drno`,`itemNo`,`unit`,`qty`,`unitcost`,`status`,`time_stamp`,`datereceived`,`warehouseid`) values (1,'2','123',51,'PC',10,9.00,1,'2017-03-12 17:40:05',NULL,1),(2,'2','123',45,'PC',10,11.00,1,'2017-03-12 17:40:05',NULL,1),(3,'3','111',172,'BOX',1,20.00,1,'2017-03-12 21:14:20',NULL,1),(4,'3','111',196,'PACK',1,30.00,1,'2017-03-12 21:14:20',NULL,1),(6,'2','123',33,'REAM',1,0.00,1,'2017-04-20 16:23:42',NULL,1),(7,'2','123',33,'REAM',1,0.00,1,'2017-04-20 16:24:07',NULL,1),(8,'2','123',33,'REAM',1,0.00,1,'2017-04-20 16:24:07',NULL,1),(9,'3','111',172,'',1,179.28,0,'2017-04-27 16:21:09',NULL,1),(10,'3','111',12,'BOX',1,0.00,0,'2017-04-27 16:35:23',NULL,1),(11,'1','test',1,'PC',1,10.00,0,'2017-04-28 08:17:02',NULL,1);
