                        ...
                        <div class="col-md-3">
							<ul>
								...
								foreach ($suppliers_added as $supplier_list2):
										...
										echo "<li><a href='../canvass/".$prid."/".$supplier_list2['supplierid']."'><strong>".$supplier_list2['supName']."</strong></a>";
										echo " <button class='' onClick='removesupplier(".$supplier_list2['supplierid'].")'><i class='fa fa-times'></i></button></li><br>";
