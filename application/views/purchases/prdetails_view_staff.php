			...
			<!-- Alert Messages Block -->
                        <div class="block">
                            ...
                            <div class="row">
                                    ...
                                    <!-- Success Alert -->
								<?php if($prmaindetails['prstatus']=="APPROVED"){
									 echo "<div class='col-sm-6 col-lg-3'>
										<div class='alert alert-success alert-dismissable'>
											<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
											<h4><strong>Approved</strong></h4>
											<p>This Purchase Request is already approved!</p>
										</div>
										<!-- END Success Alert -->
									</div>";
								...
								if($prmaindetails['prstatus']=="PENDING"){
									 echo "<div class='col-sm-6 col-lg-3'>
                                    <!-- Danger Alert -->
                                    <div class='alert alert-danger alert-dismissable'>
                                        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                                        This Purchase Request is still Pending.</p>
                                    </div>
                                    <!-- END Danger Alert -->
                                </div>";}
                               ...
                               <div class='col-sm-6 col-lg-3'>
                                    ...
                                    <div class='alert alert-info alert-dismissable'>
                                        ...
                                        <p>Add Supplier and award before Generating PO.</p>
                                    </div>
                                    <!-- END Info Alert -->
                                </div>
...
<div style="font-family:Arial;font-size:12px;">
	<div style="float:left;width:0%;position:relative;left:40px;"><img width="100" src="<?=base_url();?>public/img/print_logo.png"></div>
	...
	<br>
			...
			<div class="block full">
				...
				<div class="form-group">
					<input type="hidden" id="prid" name="state-normal" class="form-control" value="<?php echo $prid;?>" >
						...
						<label class="col-md-2 control-label hidden" for="state-normal">APR No.</label>
				...
				?>
						...
						<label class="col-md-1 control-label hidden" for="state-normal">Date</label>
                        <div class="col-md-1">
                            <input type="text" id="aprdate" name="example-datepicker3" class="form-control input-datepicker hidden" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" value="<?php echo $prmaindetails['aprdate'];?>" disabled>
                        </div>
						
						<label class="col-md-1 control-label" for="state-normal">Section</label>
                        <div class="col-sm-2">
                        ...
                        <div class="col-md-3">
						<label class="col-md-1 control-label" for="state-normal"><?php echo $prmaindetails['prstatus'];?></label>
							<input type="hidden" id="prstatus" value="<?php echo $prmaindetails['prstatus'];?>">
		...
		<div class="block full">
			...
			<div class="tab-content">
				...
				?>
				<tr><td colspan="7"><button class="pull-right btn btn-primary notification" title="Save Price" id="notification" onClick="saveallprices(<?php echo $prid;?>)"><i class="gi gi-floppy_saved"></i> Save All Prices</button></td></tr>
									</tbody>
					</table>
					 </div>
