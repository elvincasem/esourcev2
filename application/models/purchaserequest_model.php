...
class Purchaserequest_model extends CI_Model
{
	...
	public function updateallpricescanvass($aocid,$unitprice)
	{
	...
	{
		$itemlist = $this->db->query("SELECT purchase_pr_aoc.aocid,purchase_pr_aoc.prid,purchase_pr_aoc.pritemsid,purchase_pr_aoc.supplierid,purchase_pr_aoc.unitprice,purchase_pr_items.itemid,purchase_pr_items.description,purchase_pr_items.qty,purchase_pr_items.unit FROM purchase_pr_aoc LEFT JOIN purchase_pr_items ON purchase_pr_aoc.pritemsid = purchase_pr_items.pritemsid WHERE supplierid=$supplier_id AND purchase_pr_aoc.prid=$id");
		return $itemlist->result_array();
